            ...
            <iframe width="100%" height="120px" src='./html/menu_principal.html'></iframe>
                <? if(isset($_GET['inclusao']) && $_GET['inclusao'] == 1 ) { ?>
                    <div class="bg-success pt-2 text-white d-flex justify-content-center">
                        <h5>Embalagem inserido com sucesso!</h5>
                    </div>
                <? }?>
			...
			<div class="row">
				<div class="col-md-3">
					...
					<div class="container pagina">
						<div class="row">
							<div class="col">
								<h4>Nova Embalagem</h4>
                                                                <hr />

                                                                <form method="post" action="../controller/embalagem.controller.php?acao=inserir">
                                                                        <div class="form-group">
                                                                                <label>Descrição:</label>
                                                                                <input type="text" class="form-control is-valid" name="descricao" required>
                                                                                </br>
                                                                                <label>Quantidade:</label>
                                                                                <input type="number" class="form-control is-valid" name="qtde" min="0" required>
                                                                        </div></br>
